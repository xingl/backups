program vz_test
        ...
        write (gamma_unit,'(7a12)') 'kx','ky','kz','omega','','int',''
        call open_output_file(out_unit,'.res')
        write (out_unit,'(13a12)') 'kx','ky','kz','coeff_a','real_discrim','v1','',&
                                        'v2','','res1','','res2',''
...
contains
  ...
  subroutine vz_integral_residue(vy,omega,s,res_v1,res_v2,shift_vz)
        ...
        write(out_unit,'(13e12.4)') kx,ky,kz,coeff_a,real_discrim,v1,v2,res_v1,res_v2
