program res_itg
        ...
        real (kind=8) :: tprime0, fprime0, omd0
...
subroutine quadratic_solution(omega_quadr)

        implicit none
        
        complex(kind=8), intent(out) :: omega_quadr
        ...
        t = 1 
        call vy_integral_simpson(omega_quadr,vy_1,vy_2,term1,s,t)
        !print*, t,term1
        t = 2
        call vy_integral_simpson(omega_quadr,vy_1,vy_2,term2,s,t)
        !print*, t,term2
        t = 3 
        call vy_integral_simpson(omega_quadr,vy_1,vy_2,term3,s,t)
        !print*, t,term3
 ...
 subroutine pick_seeds
        ...
        if (kz==0..and.ky<0.8) then
           call quadratic_solution(omega_quadr)
           seed1 = omega_quadr
        else if (iomd==1.and.ifprime==1.and.itprime==1.and.iky==1.and.ikz==1.and.ikx==1) then
           seed1 = om1_re + om1_im*zi
        else if (iomd==1.and.ifprime==1.and.itprime==1.and.iky==1.and.ikz==1.and.ikx==1.and.aimag(root_ikyzx_1)>aimag(root)) then
           seed1 = root_ikyzx_1
        else if (iomd==1.and.ifprime==1.and.itprime==1.and.ikz==1.and.ikx==1.and.aimag(root_ikzx_1)>aimag(root)) then
           seed1 = root_ikzx_1
        else if (iomd==1.and.ifprime==1.and.itprime==1.and.ikx==1.and.aimag(root_ikx_1)>aimag(root)) then
           seed1 = root_ikx_1
        else if (iomd==1.and.ifprime==1.and.itprime==1.and.iky==iky_ref(1).and.ikz==ikz_ref(1).and.ikx==ikx_ref(1).and.aimag(root_ikyzx_ref)>aimag(root)) then
           seed1 = root_ikyzx_ref
        else if (iomd==1.and.ifprime==1.and.itprime==1.and.ikz==ikz_ref(1).and.ikx==ikx_ref(1).and.aimag(root_ikzx_ref)>aimag(root)) then
           seed1 = root_ikzx_ref
        else if (iomd==1.and.ifprime==1.and.itprime==1.and.ikx==ikx_ref(1).and.aimag(root_ikx_ref)>aimag(root)) then
           seed1 = root_ikx_ref
        else 
           seed1 = root
        end if
...
subroutine vy_integral_simpson(omega,vy_a,vy_b,integral,s,t)
  ...
  subroutine read_input_file
        ...
        namelist / parameters / sec_nsteps,nkz,dkz,kz0,kz1, &
                                nky,dky,ky0,ky1,dfprime,nfprime, &
                                fprime0,dtprime,ntprime, &
                                tprime0, nomd,domd,omd0, &
                                vy_1,vy_2,vz_1,vz_2,om1_re,om1_im, &
                                A,vi,int_tol,sec_tol,fr, &
...
subroutine init_grids
        ...
        do itprime = 1, ntprime
                tprime_grid(itprime) = itprime*dtprime+tprime0
        end do
        do iomd = 1, nomd
