program fs_itg
        ...
        integer :: gamma_unit=104, Dmixing_unit=102
           ...
           do iky = iky_ref(1), nky
              ...
              do ikz = ikz_ref(1), nkz
                  ...
                  if (.not.aimag(omega_kx_max)==-9999.0) then  
                      ikx_ref = minloc(abs(kx_grid-kx_gam))
                      root = omega_kx_max
...
contains
 ...
 subroutine pick_seeds
        ...
        if (itheta==n_skip.and.iky==iky_ref(1).and.ikz==ikz_ref(1).and.ikx==ikx_ref(1)) then
 ...
 subroutine kx_scan (kx_maxgam,omega,kx_maxDmix,Dmixing)
        ...
        complex (kind=8) :: root_tmp
          ...
          Dmixing_kx_scan = aimag(omega_grid)/(kx_grid**2+ky**2)
