program fs_itg
        ...
        real(kind=8), dimension(:), allocatable :: kx_ky,delkz_ky
        real(kind=8), dimension(:), allocatable :: Dmixing_theta
        integer(kind=8), dimension(:),allocatable :: ky_max_ind
        ...
        integer :: gamma_unit=104, Dmix_kx_unit=102,Dmix_ky_unit=105
        ...
        do itheta = 1, n_fs, n_skip
           ...
           write (Dmix_ky_unit,*)
           ky_max_ind = maxloc(Dmixing_ky)
           Dmixing_theta(itheta) = maxval(Dmixing_ky)
           write (Dmix_theta_unit, '(7e12.4)') theta_fs,tprime,fprime,&
                        kx_ky(ky_max_ind(1)),ky_grid(ky_max_ind(1)),&
                        delkz_ky(ky_max_ind(1)),Dmixing_theta(itheta)
...
contains
 ...
 subroutine kx_scan 
        ...
        real (kind=8) :: kx_maxgam, kx_maxDmix, Dmixing
        complex (kind=8) :: omega
...
subroutine init_grids
        ...
        allocate(omega_grid(nkx),omega_kx_kz(nkx,nkz),Dmixing_kx_kz(nkx,nkz))
        allocate(Dmixing_ky(nky),Dmixing_theta(n_fs))
        allocate(kx_ky(nky),delkz_ky(nky))
