program fs_itg
        ...
        call open_output_file(Dmixing_unit,'.Dmix')
        write (Dmixing_unit,'(7a12)') "theta","tprime","fprime","kx",&
                                "ky","delkz","Dmixing"
 ...
 subroutine calc_Dmixing
        ...
        do kx_ind = 1, nkx
           do idelkz = 1, ndelkz
              ...
              print*, 'Dmixing_avg'
              print*, Dmixing_tmp
              write (Dmixing_unit, '(7e12.4)') theta_fs,tprime,fprime,&
                                        kx_grid(kx_ind),ky,delta_kz,&
                                        Dmixing_tmp
           end do
           write (Dmixing_unit, *)
        end do             
