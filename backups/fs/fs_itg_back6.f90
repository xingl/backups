           ...
           do iky = 1, nky
              ...
              do ikz = 1, nkz
                  ...
                  if (.not.aimag(omega_kx_max)==-9999.0) then  
                      ...
                      if (ikz==1) root_kz = omega_kx_max
                      if (itheta==1) root_theta = omega_kx_max
                  end if
              end do
              write (gamma_unit,*)
              write (Dmixing_unit,*)
...
contains
 ...
 subroutine pick_seeds
        ...
        if (itheta==1.and.iky==1.and.ikz==1.and.ikx==ikx_ref(1)) then
           seed1 = om1_re + om1_im*zi
        else if (iky==1.and.ikz==1.and.ikx==ikx_ref(1)) then
           seed1 = root_theta
        else if (ikz==1.and.ikx==ikx_ref(1)) then
           seed1 = root_kz
 ...
 subroutine kx_scan (kx_maxgam,omega,kx_maxDmix,Dmixing)
        ...
        complex (kind=8) :: root_tmp
          ...
          do ikx = ikx_ref(1), 1, -1
             ...
             print*, "kx,kv,ky,kz,tprime,fprime,theta_fs"
             print*, kx,kv,ky,kz,tprime,fprime,theta_fs
             call pick_seeds
             print*,seed1,seed2
