...
subroutine quadratic_solution(omega)
        ...
        term1 = 1. + theta*Zeff - term1 + zi*nu0

        omega1 = -(term2+term3)/term1
        print*, 'term2/omega*n, term3/omega*t'
        print*, term2/fprime/ky, term3/tprime/ky
        print*, 'omega1'
        print*, omega1
        omega = omega1
