...
contains
  ...
  subroutine vz_integral(omega,vy,integral,s)
        ...
        integer :: n
        real(kind=8) :: kv,v0,coeff_a,coeff_b,coeff_d
        ...
        x_left = int_a
        x_right = x_left + dx
        call integrand(x_left,vy,omega,v1,f_left,s)
        integral = 0.0

        do while (x_left<int_b)
                x_center = 0.5*(x_left+x_right)
                call integrand(x_center,vy,omega,v1,f_center,s)
                call integrand(x_right,vy,omega,v1,f_right,s)
        ...
        write(out_unit,'(13e12.4)') kx,ky,kz,omega,v1,v2,tmp_res1,tmp_res2

  end subroutine

  subroutine integrand(vz,vy,omega,v1,int_tmp,s)
