...
subroutine dispersion_relation(omega, rhs)
        ...
        complex (kind=8) :: integral_te_l_nu2, integral_te_s_nu2
        integer(kind=8) :: s
        ...
        if (t_e==0.) then
            ...
            s = 6
            call vy_integral(omega,integral_te_s_nu2,s)
            ...
            write (Dmixing_unit, '(13e12.4)') nu0,omega, &
                integral_te,integral_te_s_nu,integral_te_s_nu2,&
...
subroutine init_output_files
        ...
        write (Dmixing_unit,'(13a12)') "nu0","omega","full_int",&
                "s_nu_int","s_nu_int2","l_nu_int","l_nu_int2"
