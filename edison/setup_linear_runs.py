...
lx_a = '0.15'
nx0_glob = 512
batch_script_job_prefix = '#PBS -N '
submit_command = 'qsub'
ExB_glob = 0.0   #'scan' for both 0.0 and -1111.0
### For kx_center scan
num_kxcenter = 5
gene_dirname = 'gene_dtsc/'
######Modify
...
basedir='/scratch/scratchdirs/drhatch/iterp/'
diagdir = basedir+case
#homedir = '/home1/01658/drhatch/'
homedir = '/global/u2/d/drhatch/'
